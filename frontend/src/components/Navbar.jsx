        ...
        <div className={`nav-menu${isMenuOpen ? " active" : ""}`}>
          ...
          <div className="nav-links">
            ...
            <button className={isActive("/explore")}
              onClick={() => handleNavigation("/explore")}>Explore Gigs</button>
            <button className={isActive("/become-seller")}
              onClick={() => handleNavigation("/become-seller")}>Become a Seller</button>
          </div>
